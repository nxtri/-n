...
/**
 * ProfileModal - Modal xem/sửa thông tin cá nhân và đổi mật khẩu
 */
const EyeIcon = () => (
 ...
 * Chức năng: Hiển thị và quản lý thông tin cá nhân của người dùng.
 * - Xem thông tin cơ bản: Họ tên, SĐT, Email, CCCD, Địa chỉ.
 * - Chỉnh sửa thông tin cá nhân.
 * - Đối với Chủ nhà: Quản lý thông tin tài khoản ngân hàng (VietQR).
 * - Chức năng đổi mật khẩu với các ô nhập mật khẩu cũ/mới và xác nhận.
 */
const ProfileModal = ({
  showProfileModal,       // State boolean ẩn/hiện modal
  setShowProfileModal,    // Hàm cập nhật trạng thái ẩn/hiện modal
  isEditingProfile,       // State boolean đang ở chế độ chỉnh sửa thông tin hay không
  setIsEditingProfile,    // Hàm bật/tắt chế độ chỉnh sửa thông tin
  isChangingPassword,     // State boolean đang ở chế độ đổi mật khẩu hay không
  setIsChangingPassword,  // Hàm bật/tắt chế độ đổi mật khẩu
  profileData,            // Dữ liệu profile đang nhập liệu trong form
  setProfileData,         // Hàm cập nhật dữ liệu profile khi nhập liệu
  passwordData,           // Dữ liệu mật khẩu đang nhập liệu trong form đổi mật khẩu
  setPasswordData,        // Hàm cập nhật dữ liệu mật khẩu
  showOldPwd,             // State hiển thị mật khẩu cũ (dạng text hay password)
  setShowOldPwd,          // Hàm bật/tắt hiển thị mật khẩu cũ
  showNewPwd,             // State hiển thị mật khẩu mới
  setShowNewPwd,          // Hàm bật/tắt hiển thị mật khẩu mới
  showConfirmPwd,         // State hiển thị xác nhận mật khẩu mới
  setShowConfirmPwd,      // Hàm bật/tắt hiển thị xác nhận mật khẩu
  handleSaveProfile,      // Hàm xử lý khi lưu thông tin cá nhân
  handleSavePassword,     // Hàm xử lý khi lưu mật khẩu mới
  user,                   // Thông tin người dùng hiện tại từ context/API
  canEdit = true          // Quyền chỉnh sửa (mặc định là true)
}) => {
          ...
          {isChangingPassword ? (
            ...
            <>
              ...
              <button 
                ...
                className="px-8 py-3 bg-success text-white rounded-2xl font-black shadow-lg shadow-success/20 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-2"
              >
